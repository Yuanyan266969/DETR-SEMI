    ...
    for image_id, filename in enumerate(label_files):
        ...
        for shape in label_file.shapes:
            ...
            try:
                ...
                print(f"Error creating mask for shape: {shape}")
...
def main():
    ...
    x_train, x_test, y_train, y_test = train_test_split(feature_files, label_files, test_size=0.484)
